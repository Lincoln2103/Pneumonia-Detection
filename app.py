...
def main():
    ...
    st.sidebar.markdown("**Hi I am Lincoln Nguyen**")
    st.sidebar.markdown("An Machine Learning and Artificial Intelligence Enthusiast")

    st.sidebar.markdown("### 💫 About Me:")
    st.sidebar.markdown("- 💻 Currently learning: Python, C++, R, Javascript, MATLAB, AI, and Machine Learning")
    st.sidebar.markdown("- 🔍 Exploring ways to apply technology in medicine to improve patient care and healthcare solutions")
    st.sidebar.markdown("- 🌱 Open to collaborations, especially in healthcare tech projects and AI applications!")
